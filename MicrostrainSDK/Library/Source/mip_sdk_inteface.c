...
u16 mip_interface_init(char *port_name, u32 baudrate, mip_interface *device_interface, u32 packet_timeout_val)
{
 u16 i;
 ...
 if(mip_sdk_port_open(&device_interface->port_handle, port_name, baudrate) != MIP_USER_FUNCTION_OK)
