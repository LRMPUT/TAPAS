...
#include "../../TapasQt/CameraWindow.h"
...
static const char qt_meta_stringdata_CameraWindow[] = {
    "CameraWindow\0"
};
...
const QMetaObjectExtraData CameraWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CameraWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_CameraWindow,
      qt_meta_data_CameraWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CameraWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CameraWindow))
